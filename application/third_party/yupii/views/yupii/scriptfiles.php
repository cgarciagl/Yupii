...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>/assets/js/dataTables/jquery.dataTables.min.js"></script>
...
<?php if (get_instance()->config->item('yupii_theme')) : ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/themes/<?php echo get_instance()->config->item('yupii_theme') ?>/bootstrap.min.css" type="text/css" />
<?php endif; ?>
<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/css/yupii.min.css" type="text/css" />